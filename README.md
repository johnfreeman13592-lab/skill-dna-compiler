...
<p align="center">
  <a href="https://github.com/johnfreeman13592-lab/skill-dna-compiler/releases/tag/v0.1.0-beta.4"><img alt="Release" src="https://img.shields.io/github/v/release/johnfreeman13592-lab/skill-dna-compiler?include_prereleases&label=beta&color=7c3aed"></a>
...
> [!IMPORTANT]
> **[Download Skill DNA Compiler v0.1.0-beta.4 for Windows](https://github.com/johnfreeman13592-lab/skill-dna-compiler/releases/download/v0.1.0-beta.4/skill-dna-compiler-0.1.0-beta.4-windows-x64.zip)**
